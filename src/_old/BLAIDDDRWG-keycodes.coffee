...
keycode_by_keynames =
  ...
  'alt':                    18
  'pause':                  19
  'capslock':               20 ### this setting valid when capslock has default behavior; see below ###
  'escape':                 27
  'space':                  32
  'page-up':                33
  'page-down':              34
...
do ->
  ...
  ### This setting valid when OS keyboard configured with 'Make Caps Lock an additional Hyper' ###
  map.set 0, 'capslock'
