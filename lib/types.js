...
(function() {
  ...
  this.declare('replace_text_event', {
    tests: {
      "? has key 'otext'": function(x) {
        return this.has_key(x, 'otext');
      },
      "? has key 'ntext'": function(x) {
        return this.has_key(x, 'ntext');
      },
      "? has key 'tsnr'": function(x) {
        return this.has_key(x, 'tsnr');
      },
      "? has key 'sigil'": function(x) {
        return this.has_key(x, 'sigil');
      },
      "? has key 'origin'": function(x) {
        return this.has_key(x, 'origin');
      },
      "? has key 'target'": function(x) {
        return this.has_key(x, 'target');
      },
      "? has key 'tsm'": function(x) {
        return this.has_key(x, 'tsm');
      },
      ...
      '?.match is a *text': function(x) {
        return (x.match == null) || this.isa.text(x.match);
      }
    }
  });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('settings_for_insert_tsm', {
    tests: {
      "?.toggle is *boolean": function(x) {
        return (x.toggle == null) || this.isa.boolean(x.toggle);
      }
    }
  });
