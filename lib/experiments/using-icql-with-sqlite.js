...
(function() {
  'use strict';
  var $, $async, CND, ICQL, IME, INTERTYPE, PATH, PD, assign, badge, boolean_as_int, debug, echo, help, info, inspect, join_path, jr, rpr, select, urge, warn, whisper, xrpr, xrpr2;
  ...
  this.new_db = function() {
    ...
    /* see https://sqlite.org/pragma.html#pragma_synchronous */    clear_count = db.$.clear();
  ...
  this.demo_edict2u = function(db) {
    var i, len, limit, nr, path, probe, probes, ref, ref1, row;
    ...
    ref1 = db.$.query("select * from edict2u where reading like 'ちゅうごく%' order by reading limit 5;");
    for (row of ref1) {
      info(row.candidate);
    }
    //.........................................................................................................
