...
(function() {
  'use strict';
  var CND, _lognr, abspath, alert, app_t0, assign, badge, debug, format_float, get_times, help, info, jr, k, remote, rpr, rprocess, skip_events, t_prv, urge, warn, whisper;
  ...
  rprocess.stdout.write('µ55398' + (((function() {
    var results;
    results = [];
    for (k in (require('electron')).remote) {
      results.push(k);
    }
    return results;
  })()).join(', ')) + '\n');
