...
(function() {
  ...
  this.main_2 = function() {
    ...
    return this.render(() => {
      ...
      /* ------------------------------------------------------------------------------------------------ */
      /* CodeMirror                                                                                       */
      this.CSS('./codemirror-5.39.0/lib/codemirror.css');
      this.CSS('./codemirror-5.39.0/addon/fold/foldgutter.css');
      this.CSS('./codemirror-5.39.0/addon/dialog/dialog.css');
      this.CSS('./codemirror-5.39.0/theme/monokai.css');
      this.JS('./codemirror-5.39.0/lib/codemirror.js');
      this.JS('./codemirror-5.39.0/mode/javascript/javascript.js');
      this.JS('./codemirror-5.39.0/mode/coffeescript/coffeescript.js');
      this.JS('./codemirror-5.39.0/addon/search/searchcursor.js');
      this.JS('./codemirror-5.39.0/addon/search/search.js');
      this.JS('./codemirror-5.39.0/addon/dialog/dialog.js');
      this.JS('./codemirror-5.39.0/addon/edit/matchbrackets.js');
      this.JS('./codemirror-5.39.0/addon/edit/closebrackets.js');
      this.JS('./codemirror-5.39.0/addon/comment/comment.js');
      this.JS('./codemirror-5.39.0/addon/wrap/hardwrap.js');
      this.JS('./codemirror-5.39.0/addon/fold/foldcode.js');
      this.JS('./codemirror-5.39.0/addon/fold/brace-fold.js');
      this.JS('./codemirror-5.39.0/keymap/sublime.js');
