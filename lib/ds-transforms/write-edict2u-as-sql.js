...
(function() {
  'use strict';
  var $, $async, CND, FS, JACONV, L, PATH, PD, PSPG, as_hepburn, as_sql, assign, badge, debug, declare, echo, help, info, isa, jr, last_of, rpr, select, size_of, to_width, type_of, types, urge, validate, warn, whisper, width_of;
...
// send { badge: 'µ33734', reading, refinements: ( jr refinements ), }
  ...
  this.write_dictionary = function(settings) {
    return new Promise((resolve, reject) => {
      var target_filename, target_path;
      ...
      return new Promise((resolve) => {
        ...
        pipeline.push(this.$filter_sample());
  ...
  if (module.parent == null) {
    L = this;
    (async function() {
      var demo_jaconv_methods, settings;
      //.......................................................................................................
      settings = {
      ...
      return demo_jaconv_methods = function() {
        var method_names, pipeline, probes;
        probes = ['hyakupaasento', 'ｈａｋｕｐａａｓｅｎｔｏ', '100ぱーせんと', '100パーセント', '100ﾊﾟｰｾﾝﾄ', 'ひゃくぱーせんと', '１００パーセント'];
        method_names = [
          'normalize',
          'toHan',
          // 'toHanAscii'
        ...
        pipeline.push($((probe, send) => {
          var i, len, method_name, result, results;
          send(null);
          results = [];
