...
(function() {
  'use strict';
  var CND, DB, IF, PATH, PD, TRIODE, XE, alert, badge, buffer, debug, echo, help, info, jr, kana_keyboard, kana_triode, log, remote, rpr, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  XE.listen_to('^keypress', async function(d) {
    var backspace_count, hit, matches, probe, v;
    // urge 'µ55401', jr d
    v = d.value;
    if (v.move !== 'down') {
      return;
