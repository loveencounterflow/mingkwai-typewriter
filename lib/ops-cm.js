...
(function() {
  ...
  this.cm_set_tsrs = function(tsnr) {
    ...
    var action, clasz, count, delta, fromto, fromto1, i, j, len, len1, mark, nl_count, old_mark, old_marks, range_is_point, ref;
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (range_is_point) {
        old_marks = this.cm_get_marks_in_position(fromto.from);
      } else {
        old_marks = this.cm_get_marks_in_range(fromto);
      }
      for (j = 0, len1 = old_marks.length; j < len1; j++) {
        old_mark = old_marks[j];
        ((old_mark) => {
          this.log('µ53183', `found old mark: ${rpr(this.position_and_clasz_from_mark(old_mark))}`);
          return old_mark.clear();
        })(old_mark);
      }
      if (action === 'set') {
        if (range_is_point) {
          ...
          if ((nl_count = ((this.cm_get_text(fromto)).match(/(\n*)$/))[1].length) > 0) {
            this.log('µ53284', `fromto ${rpr(fromto)} contains empty lines`);
          }
  ...
  this.emit_transcribe_event = function() {
    ...
    //.........................................................................................................
    this.log('µ53587', `TS#${rpr(S.tsnr)} (${rpr(S.transcriptor.display_name)})`);
    if (S.tsnr !== 0) {
