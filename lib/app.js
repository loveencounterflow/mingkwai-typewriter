...
(function() {
  ...
  var BrowserWindow, CND, FS, PATH, S, TEMPLATES, URL, alert, app, badge, debug, help, info, inspect, jr, log, main_window, page_html_path, ref, ref1, ref2, ref3, ref4, ref5, rpr, snarf, urge, warn, whisper;
  ...
  if (!CND.isa_number(snarf.app_t0)) {
    snarf.app_t0 = Date.now();
  }
  ...
  app.commandLine.appendSwitch('high-dpi-support', (ref = (ref1 = S.app) != null ? ref1.high_dpi_support : void 0) != null ? ref : 1);

  app.commandLine.appendSwitch('force-device-scale-factor', (ref2 = (ref3 = S.app) != null ? ref3.force_device_scale_factor : void 0) != null ? ref2 : 1.25);

  app.commandLine.appendSwitch('force-color-profile', (ref4 = (ref5 = S.app) != null ? ref5.force_color_profile : void 0) != null ? ref4 : 'sRGB');
  ...
  (function() {    //-----------------------------------------------------------------------------------------------------------
    ...
    if (!error) {
      return urge("µ32221 using electron-reloader");
    }
  })();
  ...
  this.list_versions = function() {
    ...
    var i, key, keys, len;
    keys = ['electron', 'modules', 'node', 'v8', 'chrome', 'icu', 'unicode'];
  ...
  this.launch = function() {
    ...
    return main_window.once('ready-to-show', () => {
      ...
      main_window.show();
      if ((ref6 = S.window.maximize) != null ? ref6 : false) {
        main_window.maximize();
      }
      if ((ref7 = S.window.show_devtools) != null ? ref7 : false) {
