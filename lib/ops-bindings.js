  ...
  * public/codemirror/keymap/sublime.js
  ...
  this.set_codemirror_keybindings = function() {
    ...
    mktw_keymap = {
      ...
      'Ctrl-0': (cm) => {
        return this.cm_set_tsrs_NG(0);
      },
      'Ctrl-1': (cm) => {
        return this.cm_set_tsrs_NG(1);
      },
      'Ctrl-2': (cm) => {
        return this.cm_set_tsrs_NG(2);
      },
      'Ctrl-3': (cm) => {
        return this.cm_set_tsrs_NG(3);
      },
      'Ctrl-4': (cm) => {
        return this.cm_set_tsrs_NG(4);
      }
    };
    //.........................................................................................................
  ...
  this.set_codemirror_event_bindings = function() {
    S.codemirror.editor.on('cursorActivity', (cm, change) => {
      return this.emit_transcribe_event_NG();
    });
    //.........................................................................................................
  ...
  this.set_xe_event_bindings = function() {
    ...
    return XE.listen_to('^transcribe', this, this.dispatch_transcribe_event);
  };
