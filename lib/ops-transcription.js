...
(function() {
  ...
  this.select_transcriptor = function(d) {
    ...
    this.log('µ776312-2', 'set_transcription', rpr(d.value.tsnr));
    this.log('µ776312-3', 'S.transcriptors', S.transcriptors);
    this.log('µ776312-4', 'S.transcriptors[ tsnr ]', S.transcriptors[d.value.tsnr]);
    ...
    return this.log('µ78764', 'S.codemirror.editor.doc.listSelections', S.codemirror.editor.doc.listSelections());
  };
