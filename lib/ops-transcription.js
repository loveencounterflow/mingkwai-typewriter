...
(function() {
  ...
  this.load_transcriptors = async function() {
    var arity, directory_path, i, len, module_name, module_path, on_input_types, ops, ref, ref1, ref2, relative_module_path, transcription_module, type;
    PATH = require('path');
    FS = require('fs');
    ops = {};
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      this.log(`µ44755 loading transcription ${relative_module_path}`);
      transcription_module = require(module_path);
      if (transcription_module.init != null) {
        if (ref1 = (type = CND.type_of(transcription_module.init)), indexOf.call(on_input_types, ref1) < 0) {
          throw new Error(`µ27622 expected a function for ${module_name}.init, got a ${type}`);
        }
        await transcription_module.init();
      }
      //.......................................................................................................
      if (ref2 = (type = CND.type_of(transcription_module.on_input)), indexOf.call(on_input_types, ref2) < 0) {
        throw new Error(`µ27622 expected a function for ${module_name}.on_input, got a ${type}`);
      }
      if ((arity = transcription_module.on_input.length) !== 1) {
