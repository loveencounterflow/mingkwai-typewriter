...
//.........................................................................................................
  ...
  this.insert_tsm_at_position = function(fromto, tsnr, sigil) {
    ...
    tsm_prefix = (ref = (ref1 = S.transcriptor_region_markers) != null ? ref1.prefix : void 0) != null ? ref : '\u{f11c}';
    tsm_suffix = (ref2 = (ref3 = S.transcriptor_region_markers) != null ? ref3.suffix : void 0) != null ? ref2 : '\u{f005}';
    tsm = `${tsm_prefix}<{foo-${sigil}${tsm_suffix}`;
    clasz = `tsr tsr${tsnr}`;
    fromto_right = {
    ...
    settings = {
      replacedWith: (jQuery(`<span class=xxx style='border:1px solid red'>${sigil}</span>`))[0],
      className: clasz,
      atomic: true,
      inclusiveLeft: false,
      inclusiveRight: false
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.insert_bookmark = function(position = null) {
    var i, len, ref, settings, sigil;
    if (position != null) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      position = ref[i];
      if (!this.cm_range_is_point(position)) {
        this.log('µ48733-2', "non-point ranges not implemented");
        return null;
      }
      break;
  ...
  this.on_replace_text = function(d) {
    ...
    // @insert_tsm_at_position v.origin, v.tsnr, v.sigil               ### insert new TSM (where called for) ###
