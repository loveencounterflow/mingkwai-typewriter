...
(function() {
  ...
  this.format_existing_tsms = function(d) {
    ...
    var cursor, finds, from, fromto, i, len, pattern, ref, ref1, ref2, ref3, text, to, tsm_prefix, tsm_suffix, tsnr;
    ...
    pattern = RegExp(`${tsm_prefix}(?<tsnr>[0-9]+)${tsm_suffix}`);
    finds = [];
...
//.........................................................................................................
    for (i = 0, len = finds.length; i < len; i++) {
      ...
      this._format_as_tsm(fromto, tsnr);
    }
    //.........................................................................................................
    return null;
  };
  ...
  this._format_as_tsm = function(fromto, tsnr) {
    /* TAINT use own API */
    var settings;
    settings = {
  ...
  this._insert_tsm = function(fromto, tsnr) {
  ...
  this.emit_transcribe_event = function() {
    ...
    var all, full_text, match, otext, pattern, position, ref, ref1, ref2, ref3, tsm_prefix, tsm_suffix, tsnr, value;
    ...
    tsm_prefix = (ref = (ref1 = S.transcriptor_region_markers) != null ? ref1.prefix : void 0) != null ? ref : '\u{f11c}';
    tsm_suffix = (ref2 = (ref3 = S.transcriptor_region_markers) != null ? ref3.suffix : void 0) != null ? ref2 : '\u{f005}';
    pattern = RegExp(`^.*(?<all>${tsm_prefix}(?<tsnr>[0-9]+)${tsm_suffix}(?<otext>.*?))$`);
