...
//.........................................................................................................
    for (i = 0, len = finds.length; i < len; i++) {
      ...
      this._format_as_tsm(fromto, tsnr, sigil);
    }
    //.........................................................................................................
    return null;
  };
  ...
  this._format_as_tsm = function(fromto, tsnr, sigil) {
    /* TAINT use own API */
    var settings;
    settings = {
  ...
  this._insert_tsm = function(fromto, tsnr, sigil) {
  ...
  this.insert_tsm = function(tsnr) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      this._insert_tsm(fromto, tsnr, ts.sigil);
    }
  ...
  this.emit_transcribe_event = function() {
    ...
    var all, full_text, match, otext, pattern, position, ref, ref1, ref2, ref3, sigil, tsm_prefix, tsm_suffix, tsnr, value;
    ...
    tsm_prefix = (ref = (ref1 = S.transcriptor_region_markers) != null ? ref1.prefix : void 0) != null ? ref : '\u{f11c}';
    tsm_suffix = (ref2 = (ref3 = S.transcriptor_region_markers) != null ? ref3.suffix : void 0) != null ? ref2 : '\u{f005}';
    pattern = RegExp(`^.*(?<all>${tsm_prefix}(?<sigil>[^${tsm_suffix}]+)${tsm_suffix}(?<otext>.*?))$`);
    if ((match = full_text.match(pattern)) == null) {
      return;
    }
    ({sigil, otext, all} = match.groups);
    tsnr = S.tsnr_by_sigils[sigil];
    if (tsnr == null) {
      tsnr = 0;
    }
