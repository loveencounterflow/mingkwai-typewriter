...
(function() {
  ...
  this.dispatch_transcribe_event = function(d) {
    var ref, ref1;
    if (((ref = S.transcriptor) != null ? (ref1 = ref.module) != null ? ref1.on_transcribe : void 0 : void 0) != null) {
      this.log('µ33111', "calling S.transcriptor.display_name", rpr(d));
  ...
  this.on_replace_text = function(d) {
    ...
    this.cm_select(d.value);
    this.cm_replace_selection(d.value.text);
