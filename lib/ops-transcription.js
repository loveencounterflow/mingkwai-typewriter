...
(function() {
  'use strict';
  var $, $async, CND, FS, KEYS, PATH, PD, T, XE, after, alert, all_keys_of, assign, badge, debug, declare, defer, help, info, inspect, isa, jr, rpr, size_of, type_of, types, types_of, urge, validate, warn, whisper, xrpr,
    indexOf = [].indexOf;
  ...
  ({isa, validate, type_of, types_of, size_of, declare, all_keys_of} = types);
  ...
  this.load_transcriptors = async function() {
    var arity, directory_path, filename, i, len, on_transcribe_types, ops, ref, ref1, ref2, relative_path, ts, tsnr, tsnr_by_sigils, type;
    PATH = require('path');
    FS = require('fs');
    tsnr = 0;
    ops = {};
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      //.......................................................................................................
      if (ts.module.init != null) {
        if (ref1 = (type = CND.type_of(ts.module.init)), indexOf.call(on_transcribe_types, ref1) < 0) {
      ...
      //.......................................................................................................
      if (ref2 = (type = CND.type_of(ts.module.on_transcribe)), indexOf.call(on_transcribe_types, ref2) < 0) {
      ...
      S.transcriptors.push(ts);
      this.log(`µ44755 ${filename} loaded as ${rpr(ts.display_name)} (TRS# ${ts.tsnr})`);
    }
    //.........................................................................................................
...
//.........................................................................................................
  ...
  this.insert_tsm_at_position = function(fromto, tsnr, sigil) {
    /* TSRM: TranScription Region Marker. TSR extends from marker up to cursor. */
    /* TAINT precompute, store in S.transcriptors: */
    var clasz, fromto_right, ref, ref1, ref2, ref3, settings, tsm, tsm_prefix, tsm_suffix;
    tsm_prefix = (ref = (ref1 = S.transcriptor_region_markers) != null ? ref1.prefix : void 0) != null ? ref : '\u{f11c}';
    tsm_suffix = (ref2 = (ref3 = S.transcriptor_region_markers) != null ? ref3.suffix : void 0) != null ? ref2 : '\u{f005}';
  ...
  this.insert_tsm = function(tsnr) {
    ...
    var action, clasz, delta, fromto, i, len, ref, ts;
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      this.insert_tsm_at_position(fromto, tsnr, ts.sigil);
    }
  ...
  this.on_replace_text = function(d) {
    ...
    /* delete original text */    S.codemirror.editor.replaceRange('', v.tsm.from, v.tsm.to);
    /* delete TSM */    S.codemirror.editor.replaceRange(v.ntext, v.target);
    ...
    this./* insert new text */thaw();
    return null;
  };

  //-----------------------------------------------------------------------------------------------------------
  this.display_candidates = function(d) {
    var glyph, glyphboxes, idx, ref, rows, v;
    v = d.value;
