...
(function() {
  ...
  this.load_transcriptors = async function() {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      this.log(`µ44755 ${filename} loaded as ${rpr(t.display_name)} (TRS# ${t.trsnr})`);
    }
    //.........................................................................................................
  ...
  this.select_transcriptor = function(d) {
    var transcriptor;
    this.log('µ776312', 'set_transcription', d);
    if ((transcriptor = S.transcriptors[d.value.trsnr]) == null) {
      return this.log(`µ988373 no such transcriptor: ${rpr(d.value)}`);
    }
    return S.transcriptor = transcriptor;
  };
