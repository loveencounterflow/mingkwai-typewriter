...
(function() {
  ...
  * refactor code into (local) modules
   ...
   */
  var $, $async, CND, FS, KEYS, PATH, PD, S, STATE, T, XE, alert, badge, debug, help, info, inspect, jr, rpr, urge, warn, whisper, xrpr;
  ...
  XE.listen_to('^candidates', this, function(d) {
    ...
    glyphboxes.on('click', (e) => {
      ...
      me.addClass('cdtsel');
      return this./* 'candidate select' (WTF?) */log(`µ33983 ${me.text()} ${jr(me.offset())}`);
    });
    //.........................................................................................................
    return null;
  });
