...
(function() {
  ...
  this.focusframe_to_editor = function(S) {
    return this._focusframe_to(S, 'leftbar');
  };

  this.focusframe_to_candidates = function(S) {
    return this._focusframe_to(S, 'rightbar');
  };

  this.focusframe_to_logger = function(S) {
    return this._focusframe_to(S, '#logger');
  };

  //-----------------------------------------------------------------------------------------------------------
  this._focusframe_to = function(S, target_selector) {
    var ff, target, tgto;
