...
(function() {
  ...
  * refactor code into (local) modules
  ...
  //-----------------------------------------------------------------------------------------------------------
  /* module-global configuration and editor state object */  XE.listen_to_all(function(key, d) {
  ...
  this.index_candidates = function() {
    ...
    /* TAINT code duplication */
    var candidate_count, col_count, col_idx, glyphbox, glyphboxes, i, idx, j, l, lcol, len, len1, len2, lnr, lrow, m, nxt_top, prv_top, ref, rnr, row, row_count, row_idx, rows, sub_glyphbox;
    glyphboxes = jQuery('#candidates-flexgrid div.glyph');
    lcol = 0;
    lrow = 0;
    prv_top = null;
